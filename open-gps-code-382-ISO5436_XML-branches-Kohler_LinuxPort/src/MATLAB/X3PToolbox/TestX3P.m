...
%  Copyright 2008, Dr. Georg Wiora, NanoFocus AG
  ...
  for i=1:numel(testfiles)
    ...
    [x,y,z,pinfor,meta] = readX3P(testfiles{i},'m');
    % Get valid points
    ...
    pinfow = writeX3P(testfilename,pinfor.FeatureType,pinfor.Units,x1,y1,z,meta);
    
    % Print point info
%     pinfow

    disp(['Rereading and comparing x3p file "',testfiles{i},'"...']);
    [x1,y1,z1,pinfow1,meta1] = readX3P(testfilename,pinfow.Units);
